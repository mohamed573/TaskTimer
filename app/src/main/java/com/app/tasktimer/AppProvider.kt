 ...
 * to define the App provider in your app gp to the AppMainfest write
 * <provider
android:authorities="learnprogramming.academy.provider"
android:name="com.app.tasktimer.AppProvider"
android:exported="false"/>  after the activity tag
 */
...
const val CONTENT_AUTHORITY = "learnprogramming.academy.provider"
...
class AppProvider : ContentProvider() {
    ...
    private fun buildUriMatcher(): UriMatcher{
        ...
        //e.g. content://learnprogramming.acadmey.provider/Tasks
        matcher.addURI(CONTENT_AUTHORITY , TasksContract.TABLE_NAME, TASKS)

        //e.g content://learnporgramming.academy.provider/Tasks/8
    ...
    // this fun (insert) ContentValues object  holding the values to insert
    override fun insert(uri: Uri, values: ContentValues?): Uri {
        ...
        when(match){
          ...
          // viewModel will react to the notification that ContentProvider will issue
        // we need to modify our contentProvider so that it notify any observer about the data changed
        if(recordId >0){
            // something was inserted
            Log.d(TAG , "insert : Settings notifyChange with $uri")
    ...
    override fun update(
        ...
        if(count>0){
            ...
            Log.d(TAG , "update : Settings notifyChange with $uri")
            context?.contentResolver?.notifyChange(uri , null)
        }
    ...
    override fun delete(uri: Uri, selection: String?, selectionArgs: Array<out String>?): Int {
        ...
        if(count>0){
            ...
            Log.d(TAG , "delete : Settings notifyChange with $uri")
            context?.contentResolver?.notifyChange(uri , null)
        }
